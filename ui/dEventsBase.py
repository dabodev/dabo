...
events = (
	...
	("ListbookPageChanged", _("Occurs when the active page in a list book changes.")),
	...
	("PageChanged", _("Occurs when the active page in a page frame changes.")),
	("RadioBox", _("Occurs when a selection is made in the radio box control.")),
