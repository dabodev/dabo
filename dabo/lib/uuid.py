...
class UUID(object):
	...
	+----------+------------------------------------------------------------------+
	|fields    |a tuple of the six integer fields of the UUID, which are also     |
	...
	+----------+------------------------------------------------------------------+
	|variant   |the UUID variant (one of the constants RESERVED_NCS, RFC_4122,    |
	|          |RESERVED_MICROSOFT, or RESERVED_FUTURE)                           |
	+----------+------------------------------------------------------------------+
	|version   |the UUID version number (1 through 5, meaningful only when the    |
	|          |variant is RFC_4122)                                              |
	+----------+------------------------------------------------------------------+
