...
class Test_Dates(unittest.TestCase):
    ...
    def test_goDate(self):
        self.assertEqual(dates.goDate(datetime.date(2006, 0o5, 0o3), 10), datetime.date(2006, 0o5, 13))
        self.assertEqual(dates.goDate(datetime.datetime(2006, 0o5, 0o3, 12, 15, 23), 10), datetime.datetime(2006, 0o5, 13, 12, 15, 23))
        self.assertEqual(dates.goDate(datetime.datetime(2006, 0o5, 0o3, 12, 15, 00), 10), datetime.datetime(2006, 0o5, 13, 12, 15, 00))
        self.assertEqual(dates.goDate(datetime.date(2006, 0o5, 0o3), -2), datetime.date(2006, 0o5, 0o1))
        self.assertEqual(dates.goDate(datetime.datetime(2006, 0o5, 0o3, 12, 15, 23), -2), datetime.datetime(2006, 0o5, 0o1, 12, 15, 23))
        self.assertEqual(dates.goDate(datetime.datetime(2006, 0o5, 0o3, 12, 15, 00), -2), datetime.datetime(2006, 0o5, 0o1, 12, 15, 00))
