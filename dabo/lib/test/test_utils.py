...
class Test_Utils(unittest.TestCase):
	...
	def test_StringFuncs(self):
		teststring = "This is a very long string with Unicode chars: Žš”Ż and 1234567890"
		revstring = "0987654321 dna Ż”šŽ :srahc edocinU htiw gnirts gnol yrev a si sihT"
