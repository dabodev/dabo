        ...
        def afterInit(self):
            ...
            ds = [
                ...
                },
                {
                    ...
                    "loc": "Giza, Egypt",
                    "constructed": "c. 2558 BC",
                },
                {
                    "landmark": "Stonehenge",
                    "loc": "Wiltshire, England",
                    "constructed": "3000 - 2000 BC",
                },
            ]
            ...
            vs.append(
                dLabel(
                    self,
                    Caption="Press the down arrow key to see the list of choices.",
                    FontBold=True,
                ),
                alignment="center",
            )
            ...
            vs.append(
                dAutoComplete(
                    self,
                    DataSet=ds,
                    SearchField="landmark",
                    FetchField="loc",
                    ColNames=["Landmark", "Location", "Year Constructed"],
                ),
                "x",
            )
