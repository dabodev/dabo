...
class dSplitter(dControlMixin, wx.SplitterWindow):
    ...
    ShowPanelSplitMenu = property(
        _getShowPanelSplitMenu,
        _setShowPanelSplitMenu,
        None,
        _(
    ...
    Split = property(
        _getSplit, _setSplit, None, _("Returns the split status of the control  (bool)")
    )
