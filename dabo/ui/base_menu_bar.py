...
)  # home/johnf/dabo3/dabo/icons/themes/tango/16x16"
...
class FileMenu(dMenu):
    ...
    def _afterInit(self):
        ...
        if self.Application.ShowCommandWindowMenu:
            self.Parent.commandWinMenuItem = self.append(
                _("Command Win&dow"),
                HotKey="Ctrl+D",
                OnHit=app.onCmdWin,
        ...
        prmpt = _("&Quit")
        self.Parent.quitMenuItem = self.append(
            prmpt,
            HotKey="Ctrl+Q",
            id=wx.ID_EXIT,
...
class EditMenu(dMenu):
    def _afterInit(self):
        ...
        self.Parent.undoMenuItem = self.append(
            _("&Undo"),
            HotKey="Ctrl+Z",
        ...
        self.Parent.redoMenuItem = self.append(
            _("&Redo"),
            HotKey="Ctrl+Shift+Z",
        ...
        self.Parent.cutMenuItem = self.append(
            _("Cu&t"),
            HotKey="Ctrl+X",
            OnHit=app.onEditCut,
        ...
        self.Parent.copyMenuItem = self.append(
            _("&Copy"),
            HotKey="Ctrl+C",
        ...
        self.Parent.pasteMenuItem = self.append(
            _("&Paste"),
            HotKey="Ctrl+V",
        ...
        self.Parent.selectAllMenuItem = self.append(
            _("Select &All"),
            HotKey="Ctrl+A",
        ...
        self.Parent.findReplaceMenuItem = self.append(
            _("&Find / Replace"),
            HotKey="Ctrl+F",
        ...
        self.Parent.findAgainMenuItem = self.append(
            _("Find A&gain"),
            HotKey="Ctrl+G",
...
class ViewMenu(dMenu):
    def _afterInit(self):
        ...
        self.Parent.increaseFontSizeMenuItem = self.append(
        ...
        self.Parent.decreaseFontSizeMenuItem = self.append(
        ...
        self.Parent.normalFontSizeMenuItem = self.append(
            _("Normal Font Size"),
            HotKey="Ctrl+/",
...
class dBaseMenuBar(dMenuBar):
    ...
    menubar (using form.MenuBar = ui.dBaseMenuBar) and then use the
