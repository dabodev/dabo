...
"""
    ...
    def testSomeSanityThings(self):
        ...
        frm.update(
            interval=0
        )  ## Need to force the update here which would otherwise happen 100 ms in the future.
    ...
    def testNullRecord(self):
        ...
        frm.update(
            interval=0
        )  ## Need to force the update here, otherwise it won't happen until 100 ms in the future.
