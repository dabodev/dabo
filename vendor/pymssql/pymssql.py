...
class pymssqlCursor:
    ...
    def execute(self, operation, params=None):
        ...
        if params and type(params) == list and type(params[0]) == tuple:
    ...
    def executemany(self, operation, param_seq):
        ...
        if len(self._result[self.__resultpos][0]) > 0:
            self.description = [
                (colname_coltype[0], colname_coltype[1], None, None, None, None, None)
                for colname_coltype in self._result[self.__resultpos][0]
            ]
