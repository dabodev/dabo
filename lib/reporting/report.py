...
class Report(Serializable):
    ...
    title = StringAttr('')
    page = ArributeChild('report.Page')
    testcursor = ArributeChild('report.TestCursor')
...
class Page(Serializable):
    ...
    foreground = ArributeChild('report.Band')
    header = ArributeChild('report.Band')
    footer = ArributeChild('report.Band')
    detail = ArributeChild('report.Band')
